 ...
 */
public class OutListRecyclerViewAdapter extends RecyclerView.Adapter<OutListRecyclerViewAdapter.ViewHolder> {

    private final List<Out_list> mValues;
    private final ChatPageActivity mListener;
    private final Activity activity;

    public OutListRecyclerViewAdapter(List<Out_list> items, ChatPageActivity listener, Activity activity) {
        mValues = items;
        mListener = listener;
