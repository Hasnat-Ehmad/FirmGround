 ...
 */
public class InListRecyclerViewAdapter extends RecyclerView.Adapter<InListRecyclerViewAdapter.ViewHolder> {

    private final List<In_list> mValues;
    private final ChatPageActivity mListener;
    private final Activity activity;

    public InListRecyclerViewAdapter(List<In_list> items, ChatPageActivity listener, Activity activity) {
        mValues = items;
        mListener = listener;
